...
set(h,'fontSize',14);
legend('M_1','M_2');
title('Chaotic Behavior Of Double Pendulum For Second Conditions','fontsize',12);
fh = figure(1);
set(fh, 'color', 'white');
...
title('Second Coniditions For \theta_1 and \theta_2','fontsize',16);
fh = figure(2);
set(fh, 'color', 'white'); 

%------------------------End OF Second Conditions---------------------------